...
class FetchNewsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // Make a last call to newsApi (cuz it has the best presentable schema and has images .., keep the best for the last ;>) )
        ...
        //     'apiKey' => $newsApiKey,
        // ]);
        // $this->mapSources($response->json()['articles']);
    ...
    private function mapSources($sources) {
    foreach ($sources as $sourceName => $source) {
        ...
        foreach ($articles as $articleData) {
            ...
            $article->image = isset($articleData['urlToImage']) ? $articleData['urlToImage'] : (isset($articleData['multimedia'][0]['url']) ? $articleData['multimedia'][0]['url'] : null );
